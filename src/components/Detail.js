        ...
        <>
            <div className="row vista-productos p-3">
                ...
                <h2 className="titulo-producto">{itemsDetalle.title}</h2>  
                    <p className="description-producto">{itemsDetalle.description}</p>
                    ...
                    <p className="description-producto-stock">Stock disponible: <strong>{itemsDetalle.stock}</strong></p>
                    <p className="description-producto-precio"><strong>Precio:</strong> ${itemsDetalle.price}</p>   
                {
                    agregadoAlCarrito === 0
                    ?
                    <ItemCount   
